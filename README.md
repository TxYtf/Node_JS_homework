...
$\color{green}{This\ is\ a\ Big\ Title}$

$\textcolor{green}{Написати\ невеликий\ консольний\ застосунок-трекер\ звичок\ без\ жодних\ сторонніх\ бібліотек,}$
$\textcolor{green}{лише\ на\ вбудованих\ модулях\ Node.js.\ Реалізувати\ лінтинг\ коду\ за\ допомогою\ ESLint(Oxlint*).}$
Мета:
